...
function displayCategories(categories) {
  ...
  <div class="col-sm-12 col-md-6 col-lg-4">
      <div class="card rounded-2" onclick="getCategoryMeals('${category.strCategory
  ...
  ingredientsList.innerHTML = ingredient
    .map(
      (data) =>
        `
        <div class="col-md-3">
          <div class="card rounded-2" onclick="getIngredientsMeals('${data.strIngredient
        }'); $('#data').css('opacity', '1'); $('#ingredients').fadeOut(300)">
            <img src="https://www.themealdb.com/images/ingredients/${data.strIngredient
        }.png" alt="ingredient" />
            <div class="overlay text-center">
